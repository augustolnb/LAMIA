"""
Agente Recomendador de Ações

Este agente é responsável por recomendar as próximas ações apropriadas
com base nos resultados de validação e pontuação do lead.
"""
